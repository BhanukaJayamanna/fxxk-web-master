            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mb_10">
                <div class="main-title d-flex">
                    ...
                    <ul class="d-flex">
                        ...
                        @if (auth()->user()->slug)
                        <li><a href="{{route('frontend.seller',auth()->user()->slug)}}" target="_blank"
                                class="primary-btn radius_30px mr-10 fix-gr-bg">{{ __('dashboard.shop_link') }}</a></li>
                        @else
                        <li><a href="{{route('frontend.seller',base64_encode(auth()->user()->id))}}"target="_blank"
                            class="primary-btn radius_30px mr-10 fix-gr-bg">{{ __('dashboard.shop_link') }}</a></li>
                        @endif

                        @if (isset($subscription) && auth()->user()->SellerAccount->seller_commission_id == 3 &&
                        $subscription->is_paid == 0 && auth()->user()->role->type != "superadmin" && auth()->user()->role->type != "admin" && auth()->user()->role->type != "staff")
                            <li><a href="{{route('seller.subscription_payment_select',$subscription->id)}}" target="_blank"
                                ...
                                <table class="table Crm_table_active4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('order_manage.show_details',$latest_order->id)}}"
                            ...
                            <div class="">
                                <table class="table Crm_table_active4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="nowrap">
                                                {{ date(app('general_setting')->dateFormat->format, strtotime($subscription->last_payment_date)) }}
                                            </td>
