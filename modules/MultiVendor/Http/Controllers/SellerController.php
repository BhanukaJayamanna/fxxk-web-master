...
class SellerController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['subscription'] = SellerSubcription::with('pricing')->where('seller_id', auth()->id())->latest()->first();
    ...
    public function subscriptionPaymentPage($id, PaymentGatewayService $paymentGatewayService)
    {
        ...
        if (auth()->user()->SellerAccount->subscription_type == "monthly") {
    ...
    public function subscription_payment_dtbl()
    {
        ...
        return DataTables::of($subscription)
            ...
            ->addColumn('subcription', function ($subscription) {
                return @$subscription->transaction->morphable->pricing->name;
            })
            ->addColumn('type', function ($subscription) {
                return @$subscription->transaction->morphable->user->SellerAccount->subscription_type ?? 'X';
            })
