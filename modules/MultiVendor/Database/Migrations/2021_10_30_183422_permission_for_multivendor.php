        ...
        if(Schema::hasTable('permissions')){
            ...
            if(!$exsist){
                ...
                $sql = [
                    ...
                    ['id'  => 515, 'module_id' => 29, 'parent_id' => null, 'module' => 'MultiVendor', 'name' => 'Subscription Payment', 'route' => 'seller_subscription_payment', 'type' => 1 ],
                    ...
                    // Order Manage
                    ['id' => 297, 'module_id' => 16, 'parent_id' => 291, 'module' => 'MultiVendor', 'name' => 'Inhouse', 'route' => 'inhouse_orders', 'type' => 3 ],
                    ['id' => 305, 'module_id' => 16, 'parent_id' => 290, 'module' => 'MultiVendor', 'name' => 'InHouse Order', 'route' => 'admin.inhouse-order.get-data', 'type' => 2 ],
                    ['id' => 306, 'module_id' => 16, 'parent_id' => 305, 'module' => 'MultiVendor', 'name' => 'Confirmed', 'route' => 'inhouse_order_confirmed', 'type' => 3 ],
                    ['id' => 307, 'module_id' => 16, 'parent_id' => 305, 'module' => 'MultiVendor', 'name' => 'Completed', 'route' => 'inhouse_order_completed', 'type' => 3 ],
                    ['id' => 308, 'module_id' => 16, 'parent_id' => 305, 'module' => 'MultiVendor', 'name' => 'Pending', 'route' => 'inhouse_order_pending', 'type' => 3 ],
                    ['id' => 309, 'module_id' => 16, 'parent_id' => 305, 'module' => 'MultiVendor', 'name' => 'Cancelled', 'route' => 'inhouse_order_cancelled', 'type' => 3 ],
                    ['id' => 310, 'module_id' => 16, 'parent_id' => 305, 'module' => 'MultiVendor', 'name' => 'Create', 'route' => 'admin.inhouse-order.create', 'type' => 3 ],
                    ['id' => 311, 'module_id' => 16, 'parent_id' => 305, 'module' => 'MultiVendor', 'name' => 'Delete', 'route' => 'admin.inhouse-order.delete', 'type' => 3 ],
                    ...
                    ['id' => 498, 'module_id' => 15, 'parent_id' => 281, 'name' => 'My Reviews', 'module' => 'MultiVendor', 'route' => 'my-reviews.index', 'type' => 2 ],
