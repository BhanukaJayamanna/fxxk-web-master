...
Route::middleware(['auth','seller'])->prefix('seller')->as('seller.')->group(function() {
    ...
    Route::get('/seller-subscription-payment-select/{id}', 'SellerController@subscriptionPaymentPage')->name('subscription_payment_select');
    ...
    Route::get('/my-subscription-payment-list', 'SellerController@my_subscription_payment')->name('my_subscription_payment_list');
